    ...
    <div class="col-md-9">
      <form method="post">
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="title" id="title" placeholder="新增文章标题">
        </div>
        <div class="form-group">
          <label for="catlist">栏目</label>
          <select class="form-control" id="catlist" name="cat_id">
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" name="content" id="content" cols="30" rows="6" placeholder="内容"></textarea>
        </div>
